...
public class carodc3_31DS_L4 {
    ...
    // static String addLikeTerms(String term1, String term2) {
    //     int[] coefficients = new int[2];
    // }

    // static String subtractLikeTerms(String term1, String term2) {

    // }

    // static String multiplyLikeTerms(String term1, String term2) {

    // }

    // static String divideLikeTerms(String term1, String term2) {
    ...
    doubleLine();
    System.out.println(String.format(RED_HL, ">> EVALUATION <<"));
